...
# Define a function to combine emojis
combine_emojis <- function(emoji1, emoji2) {
  paste(emoji1, emoji2, sep = " ")
}

# Define combined shape values
car_unlocked <- combine_emojis("\U0001F697", "\U0001F513")

# Define a set of shapes to use
shape_values <- c("\U1F52A", "\U1F44A", "\U1F3E0", car_unlocked, "\U1F494", "\U1F6CD", "\U1F3AD", "\U1F4B8", "\U1F58C", "\U1F693")
